...
public class BillPrintable implements Printable {
    ...
    public BillPrintable(HashMap<String, String> customerDetails, HashMap<String, String> items) {
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex)
        ...
        if (pageIndex == 0) {
            ...
            try {
                ...
                g2d.drawString("-------------------------------------", 12, y);
                y += yShift;
                g2d.drawString("Name: " + customerDetail.get("customer_name"), 10, y);
                y += yShift;
                g2d.drawString("Date: " + customerDetail.get("date"), 10, y);
                y += yShift;
                y += headerRectHeight;

                g2d.drawString("-------------------------------------", 10, y);
                y += yShift;
                g2d.drawString(" Qty    Item                 Price   ", 10, y);
                y += yShift;
                g2d.drawString("-------------------------------------", 10, y);
                ...
                while (hmIterator.hasNext()) {
                    ...
                    System.out.println(qty + " " + mainItem + " " + formatter.format(Double.valueOf(price)));
                    g2d.drawString(" " + qty + "  " + mainItem + "     " + formatter.format(Double.valueOf(price)), 10, y);
                    y += yShift;
                ...
                g2d.drawString("-------------------------------------", 10, y);
                y += yShift;
                g2d.drawString("Total = " + formatter.format(Double.valueOf(customerDetail.get("totalSales"))), 10, y);
                y += yShift;
                g2d.drawString("-------------------------------------", 10, y);
                y += yShift;
